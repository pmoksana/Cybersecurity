Packet Tracer - Configure Extended ACLs - Scenario
...
| Server1 | NIC       | 64.101.255.254 | Type your answers here.       | &nbsp;Type your answers here. |
| Server2 | NIC       | 64.103.255.254 | &nbsp;Type your answers here. | &nbsp;Type your answers here. |

Blank Line - no additional informationBlank Line - no additional information
...
a. Create a named extended IP access list on router RT1 which will deny **PC1** access to the HTTP and HTTPS services of Server1 and Server2. Four access control statements are required. Use **ACL** as the name of the named access list in this activity.
